...
civilian_units = ["C_Man_2_enoch_F","C_Man_1_enoch_F","C_Man_3_enoch_F","C_Farmer_01_enoch_F","C_Man_casual_4_v2_F","C_Man_casual_5_v2_F","C_Man_casual_7_F","C_Man_casual_8_F","CUP_C_C_Bully_02","CUP_C_C_Bully_01","CUP_C_C_Bully_04","CUP_C_C_Bully_03","CUP_C_C_Citizen_02","CUP_C_C_Citizen_01","CUP_C_C_Citizen_04","CUP_C_C_Citizen_03","CUP_C_C_Worker_05","CUP_C_C_Mechanic_02","CUP_C_C_Mechanic_03","CUP_C_C_Mechanic_01","CUP_C_C_Profiteer_02","CUP_C_C_Profiteer_03","CUP_C_C_Profiteer_01","CUP_C_C_Profiteer_04","CUP_C_C_Racketeer_01","CUP_C_C_Racketeer_04","CUP_C_C_Racketeer_02","CUP_C_C_Racketeer_03","CUP_C_C_Citizen_Random","CUP_C_C_Villager_01","CUP_C_C_Villager_04","CUP_C_C_Villager_02","CUP_C_C_Villager_03","CUP_C_C_Woodlander_01","CUP_C_C_Woodlander_02","CUP_C_C_Woodlander_03","CUP_C_C_Woodlander_04","CUP_C_C_Worker_03","CUP_C_C_Worker_04","CUP_C_C_Worker_02","CUP_C_C_Worker_01"];

civilian_vehicles = ["LOP_CHR_Civ_Offroad","LOP_CHR_Civ_UAZ","LOP_CHR_Civ_UAZ_Open","C_Offroad_02_unarmed_F","CUP_C_Skoda_CR_CIV","CUP_C_Lada_CIV","CUP_C_SUV_CIV","CUP_O_Hilux_unarmed_CR_CIV"];

enemy_leaders = ["rhsgref_ins_g_squadleader","rhsgref_ins_g_pilot","rhsgref_ins_g_commander","CUP_I_GUE_Officer","CUP_I_GUE_Commander"];

enemy_infantry = ["rhsgref_ins_g_grenadier_rpg","rhsgref_ins_g_militiaman_mosin","rhsgref_ins_g_spotter","rhsgref_ins_g_machinegunner","rhsgref_ins_g_arifleman_rpk","rhsgref_ins_g_medic","rhsgref_ins_g_rifleman","rhsgref_ins_g_rifleman_RPG26","rhsgref_ins_g_saboteur","rhsgref_ins_g_sniper","CUP_I_GUE_Soldier_GL","CUP_I_GUE_Saboteur","CUP_I_GUE_Ammobearer","CUP_I_GUE_Soldier_AR","rhsgref_ins_g_engineer","rhsgref_ins_g_grenadier","rhsgref_ins_g_rifleman_akm","rhsgref_ins_g_rifleman_aksu","rhsgref_ins_g_rifleman_aks74","CUP_I_GUE_Soldier_Scout","CUP_I_GUE_Soldier_AKS74","CUP_I_GUE_Crew","CUP_I_GUE_Sniper","CUP_I_GUE_Soldier_MG","CUP_I_GUE_Engineer","CUP_I_GUE_Medic","CUP_I_GUE_Soldier_AKM","CUP_I_GUE_Soldier_AKSU","CUP_I_GUE_Soldier_LAT","CUP_I_GUE_Soldier_AT"];

enemy_turrets = ["rhsgref_ins_g_DSHKM","rhsgref_ins_g_SPG9","rhsgref_ins_g_SPG9M","rhsgref_ins_g_AGS30_TriPod","rhsgref_ins_g_DSHKM_Mini_TriPod","rhsgref_ins_g_NSV_TriPod"];

enemy_vehicles_light = ["rhsgref_ins_g_uaz","rhsgref_ins_g_uaz_ags","rhsgref_ins_g_uaz_dshkm_chdkz","rhsgref_ins_g_uaz_spg9","CUP_I_Hilux_AGS30_NAPA","CUP_I_Hilux_DSHKM_NAPA","CUP_I_Hilux_SPG9_NAPA","CUP_I_Hilux_metis_NAPA","CUP_I_Hilux_UB32_NAPA","CUP_I_Hilux_MLRS_NAPA","CUP_I_T810_Unarmed_LDF","rhsgref_ins_g_gaz66","rhsgref_ins_g_kraz255b1_flatbed","rhsgref_ins_g_zil131","rhsgref_BRDM2_ins_g","rhsgref_BRDM2_ATGM_ins_g"];
enemy_vehicles_heavy = ["rhsgref_ins_g_2s1_at","rhsgref_ins_g_bmd1p","rhsgref_ins_g_bmd2","rhsgref_ins_g_bmp1p","rhsgref_ins_g_bmp2","rhsgref_ins_g_btr70","rhsgref_ins_g_btr60","rhsgref_ins_g_t72ba","rhsgref_ins_g_t72bb"];

enemy_vehicles_aa = [];
enemy_vehicles_at = ["rhsgref_ins_g_t72ba","rhsgref_ins_g_t72bb"];

enemy_vehiclesConvoyHeavy = ["rhsgref_ins_g_btr70","rhsgref_ins_g_btr60","rhsgref_BRDM2_ins_g","rhsgref_BRDM2_ATGM_ins_g"];
enemy_vehiclesConvoyLight = ["CUP_I_T810_Unarmed_LDF","rhsgref_ins_g_gaz66","rhsgref_ins_g_kraz255b1_flatbed","rhsgref_ins_g_zil131"];

enemy_heliSentry = [];
enemy_heliTransport = ["rhsgref_ins_g_Mi8amt"];
enemy_heliHeavy = ["rhsgref_cdf_Mi35"];
