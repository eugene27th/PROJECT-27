...
private _taskName = "ts#" + str serverTime;
private _sectorPosition = [false, true] call P27_fnc_getRandomSectorPos;

[_taskName, _sectorPosition, "ELLIPSE", [250, 250], "COLOR:", "ColorBLUFOR", "ALPHA:", 0.5, "PERSIST"] call CBA_fnc_createMarker;
[west, [_taskName], ["STR_P27_TASK_DESCRIPTION_SECTORDEFEND", "STR_P27_TASK_TITLE_SECTORDEFEND", ""], _sectorPosition, "CREATED", 0, true, "attack"] call BIS_fnc_taskCreate;
...
[_taskName, [_taskTrigger], [_taskName]] call P27_fnc_clearTask;