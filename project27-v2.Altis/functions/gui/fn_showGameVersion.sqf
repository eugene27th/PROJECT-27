/*
    ...
    Example:
        [] spawn/call P27_fnc_showGameVersion;
...
_ctrlText ctrlSetStructuredText (parseText (format ["<t font='PuristaMedium' align='right' size='0.75' shadow='0'>v2.0 | %1%2", _firstSymbolsUID, _lastSymbolsUID]));
