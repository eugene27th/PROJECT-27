...
private _roadPositions = [[2, 5] call BIS_fnc_randomInt, position _sectorTrigger, _sectorRadius] call P27_fnc_getRandomRoadPositions;

if ((count _roadPositions) < 2 && (random 1) < 0.5) exitWith {};
