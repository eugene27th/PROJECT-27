...
force ace_overheating_jamChanceCoef = 0.6;
...
force ace_overpressure_distanceCoefficient = 5;
force ace_parachute_failureChance = 0.0455176;
...
force ace_medical_deathChance = 0.79503;
...
force PiR_armorcoef_on = 3.5;
force PiR_bendsdown_explosion_K = 5;
force PiR_bendsdown_explosion_K0 = 0;
force PiR_bendsdown_tors_K = 7;
force PiR_bendsdown_tors_K0 = 0;
force PiR_bloodhill_on = 10;
force PiR_bloodhillM_on = 40;
force PiR_bloodkill_on = 15;
force PiR_bloodkillM_on = 30;
force PiR_bloodlosing_on = 60;
force PiR_bloodlosingKoef_on = true;
force PiR_bloodlosingM_on = 600;
force PiR_captive_on = true;
force PiR_civilian_on = true;
force PiR_contusion_on = false;
force PiR_contusionAI_on = true;
force PiR_contusioneffect_on = 5;
force PiR_countheal_on = 1;
force PiR_counthealD_on = 6;
force PiR_counthealM_on = 6;
force PiR_counthealR_on = false;
force PiR_countIFAK_on = 2;
force PiR_crawl_bendsdown_K = 6;
force PiR_crawl_bendsdown_K0 = 0;
force PiR_crawl_explosion_K = 5;
force PiR_crawl_explosion_K0 = 0;
force PiR_crawl_hands_K = 2;
force PiR_crawl_hands_K0 = 0;
force PiR_crawl_legs_K = 5;
force PiR_crawl_legs_K0 = 0;
force PiR_crawl_on = 11;
force PiR_crawl_tors_K = 8;
force PiR_crawl_tors_K0 = 0;
force PiR_crawlM_on = 40;
force PiR_DamageAllow_on = false;
force PiR_death_crawl_K = 6;
force PiR_death_crawl_K0 = 0;
force PiR_distanceiconAI_on = true;
force PiR_distanceiconDist_on = 100;
force PiR_distanceiconMedic_on = false;
force PiR_distanceiconplayer_on = true;
force PiR_distanceiconSize_on = 1.2;
force PiR_distanceiconSpectator_on = true;
force PiR_distanceiconTrans_on = 0.6;
force PiR_dragger_on = 150;
force PiR_draggerdistance_on = 9.56982;
force PiR_drop_on = 25;
force PiR_dropM_on = 65;
force PiR_dropWeapon_K = 2;
force PiR_dropWeapon_K0 = 0;
force PiR_east_on = true;
force PiR_effect_on = 5;
force PiR_garbage_on = true;
force PiR_garbageDelete_on = 1800;
force PiR_heal_on = false;
force PiR_helmet_K = 3;
force PiR_helmet_K0 = 0;
force PiR_helmet_on = false;
force PiR_IFAK_on = true;
force PiR_injuriAI_on = true;
force PiR_injuriplayer_on = false;
...
force PiR_Menu_tourniquet2Time_on = 0.7;
force PiR_Menu_tourniquet2TimeM_on = 1;
force PiR_Menu_tourniquet3Time_on = 0.5;
force PiR_Menu_tourniquet3TimeM_on = 0.7;
force PiR_Menu_tourniquet4Time_on = 0.3;
force PiR_Menu_tourniquet4TimeM_on = 0.5;
...
force PiR_Menu_tourniquetS2Time_on = 1.1;
force PiR_Menu_tourniquetS2TimeM_on = 1.4;
force PiR_Menu_tourniquetS3Time_on = 0.5;
force PiR_Menu_tourniquetS3TimeM_on = 0.7;
force PiR_Menu_tourniquetS4Time_on = 0.3;
force PiR_Menu_tourniquetS4TimeM_on = 0.5;
force PiR_Menu_tourniquetSPhase_on = 9;
force PiR_Menu_tourniquetSPhaseM_on = 10;
force PiR_MenuAI_on = true;
force PiR_moan_on = 100;
force PiR_repeatheal_on = true;
force PiR_resistance_on = true;
force PiR_scream_on = 150;
force PiR_smoke_on = true;
force PiR_stopblood_on = false;
force PiR_stopbloodAI_on = true;
force PiR_sway_on = 0.8;
force PiR_uncondition_crawl_K = 5;
force PiR_uncondition_crawl_K0 = 0;
force PiR_uncondition_explosion_K = 5;
force PiR_uncondition_explosion_K0 = 0;
force PiR_uncondition_hands_K = 5;
force PiR_uncondition_hands_K0 = 0;
force PiR_uncondition_head_K = 5;
force PiR_uncondition_head_K0 = 0;
force PiR_uncondition_legs_K = 5;
force PiR_uncondition_legs_K0 = 0;
force PiR_uncondition_tors_K = 5;
force PiR_uncondition_tors_K0 = 0;
force PiR_unknown_on = true;
force PiR_up_bendsdown_K = 5;
force PiR_up_bendsdown_K0 = 0;
