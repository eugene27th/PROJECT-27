...
force ace_medical_spontaneousWakeUpChance = 0.248129;
force ace_medical_spontaneousWakeUpEpinephrineBoost = 3.40194;
...
// ACEX ÐžÐ³Ñ€Ð°Ð½Ð¸Ñ‡ÐµÐ½Ð¸Ðµ Ð¾Ð±Ð·Ð¾Ñ€Ð°
...
// ACEX ÐŸÐ¾Ð»ÐµÐ²Ñ‹Ðµ Ñ€Ð°Ñ†Ð¸Ð¾Ð½Ñ‹
...
// ACEX Ð¤Ð¾Ñ€Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ†Ð¸Ñ
acex_fortify_settingHint = 2;

// ACEX Headless ÐºÐ»Ð¸ÐµÐ½Ñ‚
