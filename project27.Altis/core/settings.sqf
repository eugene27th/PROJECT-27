...
switch (_preset_units) do {
	case "european_aggressor": {
		...
		enemy_vehicles_light = ["rhssaf_m1025_olive_m2","rhssaf_m1025_olive","rhssaf_m998_olive_2dr_fulltop","rhssaf_m998_olive_2dr_halftop","LOP_NAPA_Truck","LOP_NAPA_Landrover","LOP_NAPA_Landrover_M2","LOP_NAPA_Offroad","LOP_NAPA_Offroad_M2","rhsgref_nat_uaz","rhsgref_nat_uaz_open","rhsgref_nat_uaz_ags","rhsgref_nat_uaz_dshkm","rhsgref_nat_uaz_spg9","rhsgref_nat_van","rhsgref_nat_van_fuel","rhsgref_nat_ural","rhsgref_nat_ural_open","rhsgref_nat_ural_work","rhsgref_nat_ural_work_open","rhsgref_cdf_gaz66_zu23","rhsgref_cdf_ural_Zu23","rhsgref_cdf_gaz66","rhsgref_cdf_zil131"];
		enemy_vehicles_heavy = ["rhsgref_nat_btr70","rhsgref_nat_ural_Zu23","rhsgref_cdf_bmd2k","rhsgref_cdf_bmp2k","rhsgref_cdf_t72ba_tv","rhsgref_cdf_t72bb_tv","rhsgref_cdf_t80b_tv","rhsgref_cdf_zsu234","rhsgref_cdf_bmp1d","rhsgref_cdf_bmp1p","rhsgref_cdf_bmd1k","rhsgref_cdf_bmp1","rhsgref_cdf_bmp2","rhsgref_BRDM2","rhsgref_cdf_btr80","rhsgref_ins_g_bmp1","rhsgref_ins_g_bmp2e","rhsgref_cdf_btr80","rhsgref_BRDM2"];
